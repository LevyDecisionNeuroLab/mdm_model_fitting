...
%% Define conditions
fitparwave = 'Behavior data fitpar_06302021'; % folder to save all the fitpar data structures
...
parfor subj_idx = 1:length(subjects)
  ...
  for domain_idx = 1:length(domains)
    ...
    if (strcmp(fitbywhat,'value') && strcmp(domain, 'MON') ==1) || strcmp(fitbywhat,'rating') || strcmp(fitbywhat,'arbitrary')
        ...
        base = 0; % value of the null outcome, $0 in the experimental design
        ...
        % constrained or constrained fitting by fminunc
